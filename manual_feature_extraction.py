...
# from: https://github.com/japolak/ETH-ML/tree/8827ca53e26a9dc7ad9f916f775e422ea2af7c4c/AML2018/task3
...
WORK_FOLDER = '/home/fot/centaur-tech/predictions/eth_aml/task3/' # change me pls!
#WORK_FOLDER = JAKUB'S
...
features_list=[]
for a_subj in range(len(x_test_data)):
    print(a_subj)
    features_list.append(np.array(extract_features(x_test_data[a_subj]), dtype=np.float64))

df = pd.DataFrame(features_list, columns=column_names)
df.to_csv('x_test_manual_features.csv')
